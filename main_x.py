...
def run(data_path='data/pbmc3k_2000.npy'):
    ...
    # -trainer
    trainer = pl.Trainer(max_epochs=EPOCHS, accelerator=DEVICE, devices=1, logger=csv_logger, callbacks=[lr_callback, early_stop_callback, progress_bar_callback, model_checkpoint_callback], log_every_n_steps=40)
